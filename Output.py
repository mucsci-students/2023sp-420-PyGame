...
"""
def print_current_puzzle(stats, shuffledPuzzle):
    prettyGuesses = get_pretty_guesses(stats)
        
        
    currentProgress = f'''
        Rank: {stats.get_rank}   
        Score: {stats.score} / {stats.maxPoints} 
        Words Guessed: {prettyGuesses}
        
        Required Letter: {shuffledPuzzle[3]}
        Optional Letters: {shuffledPuzzle[0] + ' - ' + shuffledPuzzle[1] + ' - ' + shuffledPuzzle[2] + ' - ' + shuffledPuzzle[4] + ' - ' + shuffledPuzzle[5] + ' - ' + shuffledPuzzle[6]}
